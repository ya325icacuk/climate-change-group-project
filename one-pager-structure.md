...
| Importance   | Architecture                               | Why include                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Key reference                         | Assignment   | Peer Review |
| --- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------- | ------------ | ----------  |
| 2   | **U-Net**                                  | Strong spatial feature extraction for gridded Data3D fields; widely used baseline for weather prediction                                                                                                                                                                                                                                                                                                                                                                                                                       | —                                              | Sam          | Yasmin      |
| 3   | **ResNet**                                 | ResNet50, 180?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | —                                              | Yasmin       | Loïc        |
| 1   | **FNO** (Fourier Neural Operator)          | Spectral approach is inherently basin-agnostic; proven on weather forecasting (FourCastNet)                                                                                                                                                                                                                                                                                                                                                                                                                                    | Chen et al. (2022)                             | Loïc         | Sam         |
