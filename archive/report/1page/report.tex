...
\usepackage[top=0.8cm, bottom=1.0cm, left=1.2cm, right=1.2cm]{geometry}
\usepackage{graphicx}
\usepackage{multicol}
\usepackage{booktabs}
\usepackage{tabularx}
