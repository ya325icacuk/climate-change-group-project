...
fig.savefig(FIG_DIR/"ufno_cm_wp.png",dpi=150,bbox_inches="tight"); plt.close('all')
...
fig.savefig(FIG_DIR/"ufno_cm_sp_zs.png",dpi=150,bbox_inches="tight"); plt.close('all')
...
fig.savefig(FIG_DIR/"ufno_cm_sp_ft.png",dpi=150,bbox_inches="tight"); plt.close('all')

# Save checkpoints
torch.save(best_state, PROJECT_ROOT/"experiments"/"ufno_best_wp.pt")
torch.save(ft_best.state_dict(), PROJECT_ROOT/"experiments"/"ufno_best_ft.pt")
